#!/bin/bash
# v2 assembly: 11 branded clips against the 2:08 v3 VO (media/vo/vo-v4-cut.wav).
...
ffmpeg -y -v error \
  ...
  -i media/vo/vo-v4-cut.wav -i media/edit/soft-glory.mp3 \
  -filter_complex "
...
[5:v]trim=0:12.7,setpts=PTS-STARTPTS[v5];
[6:v]tpad=stop_mode=clone:stop_duration=0.7[v6];
[7:v]trim=0:11.5,setpts=PTS-STARTPTS[v7];
[8:v]tpad=stop_mode=clone:stop_duration=1.6[v8];
...
[x5][v6]xfade=transition=fade:duration=0.4:offset=73.2[x6];
[x6][v7]xfade=transition=fade:duration=0.4:offset=87.5[x7];
[x7][v8]xfade=transition=fade:duration=0.4:offset=98.6[x8];
[x8][v9]xfade=transition=fade:duration=0.4:offset=109.8[x9];
[x9][v10]xfade=transition=fade:duration=0.5:offset=123.7[vfinal];
[11:a]adelay=500|500,apad,asplit[vo1][vo2];
[12:a]atrim=0:135.2,afade=t=in:st=0:d=2,afade=t=out:st=130.2:d=5,volume=0.9[mus];
