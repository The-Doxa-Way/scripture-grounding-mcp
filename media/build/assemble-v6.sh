#!/bin/bash
# v2 assembly: 11 branded clips against the 2:08 v3 VO (media/vo/vo-v8-cut.wav).
...
ffmpeg -y -v error \
  ...
  -i media/vo/vo-v8-cut.wav -i media/edit/soft-glory.mp3 \
  -filter_complex "
...
[3:v]tpad=stop_mode=clone:stop_duration=1.39[v3];
...
[8:v]tpad=stop_mode=clone:stop_duration=2.0[v8];
[9:v]trim=0:8.4,setpts=PTS-STARTPTS[v9];
...
[x3][v4]xfade=transition=fade:duration=0.4:offset=56.49[x4];
[x4][v5]xfade=transition=fade:duration=0.4:offset=67.59[x5];
[x5][v6]xfade=transition=fade:duration=0.4:offset=76.94[x6];
[x6][v7]xfade=transition=fade:duration=0.4:offset=91.74[x7];
[x7][v8]xfade=transition=fade:duration=0.4:offset=104.29[x8];
[x8][v9]xfade=transition=fade:duration=0.4:offset=115.87[x9];
[x9][v10]xfade=transition=fade:duration=0.5:offset=123.87[vfinal];
[11:a]adelay=500|500,volume=1.25,apad,asplit[vo1][vo2];
[12:a]atrim=0:135.4,afade=t=in:st=0:d=2,afade=t=out:st=130.4:d=5,volume=0.55[mus];
