#!/bin/bash
# v2 assembly: 11 branded clips against the 2:08 v3 VO (media/vo/vo-v7-cut.wav).
...
ffmpeg -y -v error \
  ...
  -i media/vo/vo-v7-cut.wav -i media/edit/soft-glory.mp3 \
  -filter_complex "
...
[3:v]trim=0:9.92,setpts=PTS-STARTPTS[v3];
...
[x3][v4]xfade=transition=fade:duration=0.4:offset=47.02[x4];
[x4][v5]xfade=transition=fade:duration=0.4:offset=58.12[x5];
[x5][v6]xfade=transition=fade:duration=0.4:offset=67.47[x6];
[x6][v7]xfade=transition=fade:duration=0.4:offset=82.27[x7];
[x7][v8]xfade=transition=fade:duration=0.4:offset=94.82[x8];
[x8][v9]xfade=transition=fade:duration=0.4:offset=106.4[x9];
[x9][v10]xfade=transition=fade:duration=0.5:offset=114.4[vfinal];
[11:a]adelay=500|500,volume=1.25,apad,asplit[vo1][vo2];
[12:a]atrim=0:125.9,afade=t=in:st=0:d=2,afade=t=out:st=120.9:d=5,volume=0.55[mus];
