#!/bin/bash
# v2 assembly: 11 branded clips against the 2:08 v3 VO (media/vo/vo-v3-cut.wav).
...
ffmpeg -y -v error \
  ...
  -i media/vo/vo-v3-cut.wav -i media/edit/soft-glory.mp3 \
  -filter_complex "
...
[7:v]trim=0:9.8,setpts=PTS-STARTPTS[v7];
...
[x7][v8]xfade=transition=fade:duration=0.4:offset=96.9[x8];
[x8][v9]xfade=transition=fade:duration=0.4:offset=108.1[x9];
[x9][v10]xfade=transition=fade:duration=0.5:offset=122.0[vfinal];
[11:a]adelay=500|500,apad,asplit[vo1][vo2];
[12:a]atrim=0:133.5,afade=t=in:st=0:d=2,afade=t=out:st=128.5:d=5,volume=0.9[mus];
